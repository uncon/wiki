...
1. Install the base system
		...
		pacstrap /mnt base base-devel intel-ucode efibootmgr dosfstools openssh dnsutils sudo wget git htop tmux zsh xf86-video-intel mesa-libgl libva-intel-driver libva xorg-server xorg-server-utils xorg-server-xwayland xorg-utils xf86-input-synaptics gnome gnome-extra gst-libav gvfs-smb gdm gvim cups gutenprint
